...
export name='Vitoria Regis'
export email="vitoria.oliveira405@etec.sp.gov.br"
export repositorio="https://github.com/vitoriaapregis/PAM-I-.git";

#Daqui pra baixo mexa somente se for realmente necessário ou se souber o que está fazendo :P

export branch_name="quitanda-$(date +%Y%m%d-%H%M%S)"
