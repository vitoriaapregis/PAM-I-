...
class LoginPage extends StatelessWidget {
              ...
              Container(
                ...
                child: Text(
                  ...
                  style: TextTheme.headlineLarge?.copyWith(
                    color: const Color.fromARGB(255, 204, 34, 255),
                  ),
                ),
              ),
              TextField(
  ...
  void login(BuildContext context, String usuario, String senha) {
    ...
    try {
      ...
      if (auth.estaLogado) {
        /*
        * consideraando que a navegação em aplicações flutter são
        ...
        * de login..
        *
        * como não queremos isso, usamos o pushNamedAndRemoveUntill para 
